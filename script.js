...
function secondsToMinutesSeconds(seconds) {
    ...
    // Use padStart to ensure that single-digit minutes and seconds are formatted with a leading zero
...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        ...
        <div class="playNow">
            <span>Play Now</span>
            <img class="invert" src="play-btn.svg" alt="">
        </div>
        </li>`;
    }
...
async function main() {
    ...
    //Add an event listner on play previous 
    ...
    //Add an event listner on play next
    ...
    document.querySelector(".range").getElementsByTagName("input")[0].addEventListener("change" ,(e)=> {
        console.log("Setting vol to",e.target,e.target.value,"/100")
